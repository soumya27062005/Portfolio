# Soumya Gupta — Developer & Designer Portfolio

A dark-themed personal portfolio for **Soumya Gupta** — Diploma in Computer Engineering from LJKU, currently persuing B Tech in AI & DS at JG University. Focused on UI/UX, front-end development, and GenAI integration.
...
4. **Projects** — sticky-stacking cards for AI Tutor, PiLearn, aurabank, Notch
...
|---|---|---|
| aurabank | [aurabank.vercel.app](https://aurabank.vercel.app) | React, Gemini API, Vercel |
| Class-Whisper | [classfinal.vercel.app](https://classfinal.vercel.app) | React, Tailwind, Framer Motion |
...
Designed & built by **Soumya Gupta** · [LinkedIn](https://www.linkedin.com/in/soumya-harishbhai-gupta-0b113a308/) · [GitHub](https://github.com/soumya27062005)
