...
const PROJECTS: ProjectData[] = [
    {
        ...
        col1Image1: '/Nexus.png',
        col1Image2: '/Nexus1.png',
        col2Image: '/Nexus2.png',
      },
  {
      number: '02',
      category: 'Personal',
      name: 'Bone-Fracture-Detection',
      liveUrl: 'https://bonevisionai.vercel.app',
      col1Image1: '/Bone.png',
      col1Image2: '/Bone1.png',
      col2Image: '/Bone2.png',
    },
  {
    number: '03',
    ...
    name: 'Class-Whisper',
    liveUrl: 'https://classfinals.vercel.app/',
    col1Image1: '/Class.png',
    col1Image2: '/Class1.png',
    col2Image: '/Class2.png',
  },
  {
    number: '04',
    ...
    col1Image1: '/Vistara.png',
    col1Image2: '/Vistara1.png',
    col2Image: '/Vistara2.png',
  },
];
